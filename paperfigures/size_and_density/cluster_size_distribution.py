...
for i, (heart, _) in enumerate(hearts.items()):
    ...
    #     axs[3, i].spines[loc].set_linewidth(2)

separating_patch = plt.Line2D([0, 1], [0.285, 0.285],
                              transform=fig.transFigure,
                              color="black", lw=1.5)
# separating_patch = plt.Rectangle((0.01, 0.025), 0.98, 0.26, edgecolor='black', 
#                           linewidth=1.5, fill=False)
fig.add_artist(separating_patch)
...
fig.savefig(path_save.joinpath('size_distribution_multi.png'),
